...
import sty from "./PlasmicBaseCard.module.css"; // plasmic-import: jlzDN_cwMGwABS/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__dwQSb, {
          [sty.freeBoxlong__dwQSbukCMy]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__r549T, {
            [sty.freeBoxlong__r549TukCMy]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__ujNge)}
                role={"img"}
              />
            ),
