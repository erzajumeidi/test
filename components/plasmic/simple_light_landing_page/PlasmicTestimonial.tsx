...
import Avatar from "../../Avatar"; // plasmic-import: xWJSqdwqhOOMJB/component
...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: 5kpMpuXY_1AKO9/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: wLd4hzM6H-QJLg/icon
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__lwOXj)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__orRAa)}
        >
          <div
            className={classNames(
              projectcss.all,
