...
import sty from "./PlasmicFeatureCard.module.css"; // plasmic-import: bcbu1ogfACwVx/css
  ...
  return (
    ...
    >
      {(hasVariant(variants, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__ltEiS, {
            [sty.freeBoxlong__ltEiSdfuWs]: hasVariant(variants, "long", "long")
          })}
        >
          <div
            className={classNames(projectcss.all, sty.freeBox___2Jyqg, {
              [sty.freeBoxlong___2JyqgdfuWs]: hasVariant(
                variants,
                "long",
                "long"
              )
          ...
          >
            {p.renderPlasmicSlot({
              defaultContents: (
                <svg
                  className={classNames(projectcss.all, sty.svg__l8LQr)}
                  role={"img"}
                />
              ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__z5Vxr, {
          [sty.freeBoxlong__z5VxrdfuWs]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
      ...
      {(hasVariant(variants, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__nqeKq, {
            [sty.freeBoxlong__nqeKqdfuWs]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__tsdSb)}
                role={"img"}
              />
            ),
