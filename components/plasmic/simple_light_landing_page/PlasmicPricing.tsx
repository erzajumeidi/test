...
import Plan from "../../Plan"; // plasmic-import: cACZaGJ6QhYIzC/component
import Bullet from "../../Bullet"; // plasmic-import: IdUEJkBsugmw0G/component
import Button from "../../Button"; // plasmic-import: 4ZaxGx7nqn3nPW/component
import Faq from "../../Faq"; // plasmic-import: mALvCne9zYPi1D/component
...
import sty from "./PlasmicPricing.module.css"; // plasmic-import: lqE2RediHdSFqP/css
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            ...
            >
              <div className={classNames(projectcss.all, sty.column__sUaUc)}>
                <Plan
                  className={classNames("__wab_instance", sty.plan__prRal)}
                  price={
                    <div
                      className={classNames(
                        projectcss.all,
                ...
                >
                  <Button
                    className={classNames("__wab_instance", sty.button___7S0GN)}
              ...
              <div className={classNames(projectcss.all, sty.column__rQg9)}>
                <Plan
                  className={classNames("__wab_instance", sty.plan__qCrl)}
                  description={
                    <p.Stack
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__avZy3)}
                    >
                      <Bullet
                        className={classNames(
                          "__wab_instance",
                ...
                >
                  <Button
                    className={classNames("__wab_instance", sty.button__zDrHu)}
                    color={"blue" as const}
                  >
                    {"Get started"}
                  </Button>
              ...
              <div className={classNames(projectcss.all, sty.column__x1Kc)}>
                <Plan
                  className={classNames("__wab_instance", sty.plan___6HAz)}
                  name={"Enterprise"}
                  price={
                    <div
                      className={classNames(
                ...
                >
                  <Button
                    className={classNames("__wab_instance", sty.button__krmHw)}
                    color={"outlineBlue" as const}
                  >
                    {"Get started"}
                  </Button>
          ...
          >
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__r7QXg)}
            >
              <Faq
                className={classNames("__wab_instance", sty.faq___5SEUl)}
                slot={
              ...
              <Faq
                className={classNames("__wab_instance", sty.faq__bk4Hh)}
                slot={
                  "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                }
              >
              ...
              <Faq
                className={classNames("__wab_instance", sty.faq__qXhDs)}
                slot={
                  "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                }
              >
