...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: mALvCne9zYPi1D/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___1O6Cb)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__bd4Go)}>
          <div className={classNames(projectcss.all, sty.freeBox__b18KB)}>
            {p.renderPlasmicSlot({
